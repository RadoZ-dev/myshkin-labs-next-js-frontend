...
export default function Header() {
  ...
  return (
    <header className="myshkin-labs-header bg-white py-4 sticky top-0 z-50">
      <nav className="max-w-7xl px-4" style={{ margin: "0 auto" }}>
        <div className="flex justify-between items-center h-16">
          <div className="flex-shrink-0">
            <Link
              href="/"
              className="myshkin-labs-header__logo text-2xl font-bold text-gray-800 hover:text-gray-600 transition-colors"
            >
              MИШKiN LAБS
            </Link>
          </div>
